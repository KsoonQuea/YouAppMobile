...
import 'package:youapp_mobile/pages/login/index.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  bool confirm_passwordVisibleOff = true;
          ...
          child   : Form(
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  obscureText : confirm_passwordVisibleOff, 
                  decoration  : InputDecoration(
                    labelText : 'Confirm Password',
                    border    : OutlineInputBorder(),
                    suffixIcon: IconButton(icon: Icon(confirm_passwordVisibleOff ? Icons.visibility_off : Icons.visibility), color: Colors.white54, onPressed: () {
                      setState(() => confirm_passwordVisibleOff = !confirm_passwordVisibleOff);
                    }),
                  ), // To obscure password input
                ),
                SizedBox(height: 16),
                ...
                Padding(padding: EdgeInsets.only(top: 10), child: 
                  GradientButton(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        await _submitRegisterForm(context);
                      },
                        ...
                        children: [
                          ...
                          TextSpan(
                            ...
                            recognizer: TapGestureRecognizer()..onTap = (){
                              developer.log("TextSpan is clicked.", name: "Debug");
                              Navigator.push(
                                context,
  ...
  Future<void> _submitRegisterForm(context) async {
    if (_formKey.currentState!.validate()) {
      ...
      try{
        api_response = await api_service.ApiService().postRegister(userData);
